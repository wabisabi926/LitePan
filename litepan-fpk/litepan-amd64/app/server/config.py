...
class Settings:
    WEB_HOST: str = os.getenv('LITEPAN_HOST', '0.0.0.0')
    WEB_PORT: int = int(os.getenv('LITEPAN_PORT', '5211'))
    DATABASE_PATH: str = os.getenv('LITEPAN_DATABASE_PATH', 'data/litepan.db')
    SECRET_KEY: str = ""
    LOG_LEVEL: str = "INFO"
    LOG_RETENTION_DAYS: int = 10

    ADMIN_USERNAME: str = os.getenv('LITEPAN_ADMIN_USERNAME', 'admin')
    ADMIN_PASSWORD: str = os.getenv('LITEPAN_ADMIN_PASSWORD', 'admin')
    ...
    def _get_or_create_secret_key(cls):
        ...
        data_dir = os.getenv('LITEPAN_DATA_DIR', 'data')
        secret_file = Path(data_dir) / '.secret_key'
